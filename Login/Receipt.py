...
class Bill_App:
    def __init__(self, root):
        ...
        cname_txt = Entry(F1, width=15, textvariable=self.customerID, font="arial 12", bd=7, relief=SUNKEN).grid(row=0,
                                                                                                             column=1,
                                                                                                             pady=0,
                                                                                                             padx=3)
        ...
        cphn_txt = Entry(F1, width=15, textvariable=self.c_name, font="arial 12", bd=7, relief=SUNKEN).grid(row=0,
                                                                                                            column=3,
                                                                                                            pady=5,
                                                                                                            padx=3)
        ...
        c_bill_txt = Entry(F1, width=15, textvariable=self.c_phon, font="arial 12", bd=7, relief=SUNKEN).grid(
        ...
        c_bill_txt = Entry(F1, width=15, textvariable=self.address, font="arial 12", bd=7, relief=SUNKEN).grid(
        ...
        bath_lbl = Label(F2, text="Light Category", font=("times new roman", 17, "bold"), bg="WHITE", fg="red").grid(
            row=0, column=0, padx=10, pady=10, sticky="w")

        bath_lbl = Label(F2, text="Qty", font=("times new roman", 17, "bold"), bg="WHITE", fg="red").grid(
            row=0, column=1, padx=10, pady=10, sticky="w")

        bath_lbl = Label(F2, text="Price per Unit ($)", font=("times new roman", 17, "bold"), bg=bg_color2, fg="red").grid(
        ...
        light1_lbl = Label(F2, text="Light1", font=("times new roman", 16, "bold"), bg=bg_color2,
        ...
        light1_entry = Entry(F2, width=10, textvariable=self.light1, font=("times new roman", 14, "bold"), bd=5,
                               relief=SUNKEN).place(x=190, y=60, width=40, height=40)
        light1_txt = Label(F2, width=10, text="50", font=("times new roman", 14, "bold"), bd=5,
                               relief=SUNKEN).place(x=260, y=60, width=100, height=40)

        light2_lbl = Label(F2, text="Light2", font=("times new roman", 16, "bold"), bg=bg_color2,
        ...
        light2_entry = Entry(F2, width=10, textvariable=self.light2, font=("times new roman", 14, "bold"), bd=5,
                           relief=SUNKEN).place(x=190, y=110, width=40, height=40)
        light2_txt = Label(F2, width=10, text="60", font=("times new roman", 14, "bold"), bd=5,
                               relief=SUNKEN).place(x=260, y=110, width=100, height=40)

        lightsmart_lbl = Label(F2, text="SmartHome1", font=("times new roman", 16, "bold"), bg=bg_color2,
                           fg=bg_color).grid(row=3, column=0, padx=10, pady=10, sticky="e")
        lightsmart_entry = Entry(F2, width=10, textvariable=self.LightSmart, font=("times new roman", 14, "bold"), bd=5,
                           relief=SUNKEN).place(x=190, y=160, width=40, height=40)
        lightsmart_txt = Label(F2, width=10, text="70", font=("times new roman", 14, "bold"), bd=5,
                               relief=SUNKEN).place(x=260, y=160, width=100, height=40)
        ...
        bath_lbl = Label(F2, text="Safe Category", font=("times new roman", 17, "bold"), bg="WHITE", fg="red").grid(
            row=0, column=0, padx=10, pady=10, sticky="w")
        ...
        safe1_lbl = Label(F2, text="Safe1", font=("times new roman", 16, "bold"), bg=bg_color2,
                               fg=bg_color).grid(row=1, column=0, padx=10, pady=10, sticky="e")
        ...
        safe2_lbl = Label(F2, text="Safe2", font=("times new roman", 16, "bold"), bg=bg_color2,
                           fg=bg_color).grid(row=2, column=0, padx=10, pady=10, sticky="e")
        safe2_entry = Entry(F2, width=10, textvariable=self.food_oil, font=("times new roman", 14, "bold"), bd=5,
                           relief=SUNKEN).place(x=190, y=110, width=40, height=40)
        safe2_txt = Label(F2, width=10, text="120", font=("times new roman", 14, "bold"), bd=5,
                               relief=SUNKEN).place(x=260, y=110, width=100, height=40)

        safe3_lbl = Label(F2, text="Safe3", font=("times new roman", 16, "bold"), bg=bg_color2,
                           fg=bg_color).grid(row=3, column=0, padx=10, pady=10, sticky="e")
        ...
        safesmart_lbl = Label(F2, text="SmartHome1", font=("times new roman", 16, "bold"), bg=bg_color2,
                           fg=bg_color).grid(row=4, column=0, padx=10, pady=10, sticky="e")
        safesmart_entry  = Entry(F2, width=10, textvariable=self.safesmart, font=("times new roman", 14, "bold"), bd=5,
                           relief=SUNKEN).place(x=190, y=210, width=40, height=40)
        safesmart_txt = Label(F2, width=10, text="200", font=("times new roman", 14, "bold"), bd=5,
                               relief=SUNKEN).place(x=260, y=210, width=100, height=40)
        ...
        m1_txt = Entry(F6, width=18, textvariable=self.total_light_price, font="arial 10 bold", bd=7, relief=SUNKEN).grid(
        ...
        m2_txt = Entry(F6, width=18, textvariable=self.total_safe_price, font="arial 10 bold", bd=7, relief=SUNKEN).grid(
    ...
    def save_bill(self):
        ...
        if op > 0:
            ...
            f1 = open(r"C:\Users\hanna\Desktop\Y2S1\BT2101\Group Project"+"\Bills" + str(self.customerID.get()) + ".txt", "w")

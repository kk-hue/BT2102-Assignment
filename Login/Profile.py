...
class Profile:
    ...
    def __init__(self, root):
       ...
       # self.root.config(bg="white")
        ...
        self.left=ImageTk.PhotoImage(file="/Login/pro1.jpg")
        ...
        title = Label(frame1, text = "Profile Page", font=("calibri",20,"bold"),bg="white", fg="green")
        ...
        check=Button(frame1, text="Purchase History", font=("Cambria", 15, "bold"), fg="white", bg="orange")
        check.place(x=50, y=420)

        check1=Button(frame1, text="Request and Service History", font=("Cambria", 15, "bold"), fg="white", bg="orange")
        check1.place(x=250, y=420)

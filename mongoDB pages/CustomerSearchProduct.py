...
class CustomerSearchProduct:
    ...
    def __init__(self, root):
        ...
        title = Label(self.root, text="Product Search System", font=("calibri", 40, "bold"), bg="light blue", fg="white")
        ...
        db_title = Label(db_frame, text="Customer Search product", bg="crimson", fg="white", font=("calibri", 25, "bold"))
        db_title.grid(row=0, columnspan=1, pady=20)

        # ======Manage request=========

        label_search_by = Label(db_frame, text="Search by", bg="crimson", fg="white", font=("calibri", 12, "bold"))
        ...
        combo_search_by.grid(row=1, column=1, padx=6, pady=10, sticky="w")

        label_search_value = Label(db_frame, text="Search Value", bg="crimson", fg="white", font=("calibri", 12, "bold"))
        ...
        txt_search_value.grid(row=2, column=1, pady=10, padx=10, sticky="w")

        label_filter = Label(db_frame, text="Filter (optional, default as everything)", bg="crimson", fg="white", font=("calibri", 16, "bold"))
        label_filter.grid(row=3, column=0, pady=10, padx=10, sticky="w")

        label_price = Label(db_frame, text="Price", bg="crimson", fg="white", font=("calibri", 12, "bold"))
        ...
        combo_price.grid(row=4, column=1, pady=10, padx=10, sticky="w")

        label_color = Label(db_frame, text="Color", bg="crimson", fg="white", font=("calibri", 12, "bold"))
        ...
        combo_color.grid(row=5, column=1, pady=10, padx=10, sticky="w")

        label_factory = Label(db_frame, text="Factory", bg="crimson", fg="white", font=("calibri", 12, "bold"))
        ...
        combo_factory.grid(row=6, column=1, pady=10, padx=10, sticky="w")

        label_productionYear = Label(db_frame, text="Production Year", bg="crimson", fg="white", font=("calibri", 12, "bold"))
        ...
        combo_productionYear.grid(row=7, column=1, pady=10, padx=10, sticky="w")

        label_powerSupply = Label(db_frame, text="Power Supply", bg="crimson", fg="white",
                                     font=("calibri", 12, "bold"))
        ...
        combo_powerSupply.grid(row=8, column=1, pady=10, padx=10, sticky="w")
        ...
        lable_productResult = Label(self.detail_frame, text="Product Search Result", bg="crimson", fg="white", font=("calibri", 20, "bold"))
            ...
            try:
                ...
                if len(cursorList) != 0:
                    ...
                    if num_emptyProduct == len(cursorList):
                        ...
                        lable_searchResult = Label(self.detail_frame, text=str(searchResult), bg="crimson",
                                                   fg="white",
